...
export default ({dispatch, getState}) => next => action => {
  ...
  switch (action.type) {
    ...
    case types.SAVE_PROJECT: {
      next(apiRequest({url: PROJECT.SAVE_PROJECT, method: 'POST', body: action.payload, feature: types.SAVE_PROJECT}));
      break;
    }
    ...
    case types.SORT_INTERFACE: {
      next(apiRequest({url: INTERFACE.SORT_INTERFACE, method: 'POST', body: action.payload, feature: types.SORT_INTERFACE}));
      break;
    }
